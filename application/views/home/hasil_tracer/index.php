...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="fa fa-graduation-cap"></i>Hasil Tracer Study <br><small>Fakultas Ekonomi dan Bisnis (FEB) Universitas Muhammadiyah Makassar</small>
            </h1>
        </div>
    </div>
    <!-- END Page Header -->
        ...
        <div class="col-sm-12">
            <div class="block">
                ...
                <div class="block-title">
                    <h2><strong>HASIL TRACER STUDY TAHUN <?php echo date("Y");?></strong></h2>
                </div>
                <div class="row block-section text-left">
                    ...
                    <div class="row text-center">
                        ...
                        <div id="faq1" class="panel-group">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="block">
                                        <!-- Your Account Title -->
                                        <div class="block-title">
                                            <h2><strong>A.1. SUDAH BEKERJA</strong></h2>
                                        </div>
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                ...
                                <div class="col-sm-6">
                                    <div class="block">
                                        <!-- Your Account Title -->
                                        <div class="block-title">
                                            <h2><strong>A.2. BELUM BEKERJA</strong></h2>
                                        </div>
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                            ...
                            <!-- Quisioner Alumni Yang Telah Bekerja-->
