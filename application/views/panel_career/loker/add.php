...
<div id="page-content">
    ...
    <!-- END Page Header -->
    <div class="row">
        <form role="form" enctype="multipart/form-data" class="form-horizontal" method="post" action="<?php echo base_url();?>panel_career/manaj_loker_simpan" onsubmit="return konfirm()">
        <div class="col-md-8">
            ...
            <div class="block">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <textarea name="inp_deskripsi" id="inp_deskripsi" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #000; padding: 10px;"></textarea>
                    </div>
                </div>
                <div class="form-group">
