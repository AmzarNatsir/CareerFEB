                ...
                <div class="widget-extra themed-background-dark">
                    <div class="widget-options">
                        <div class="btn-group btn-group-xs">
                            <a href="<?php echo base_url();?>panel_career/manaj_loker_baru" class="btn btn-default" data-toggle="tooltip" title="Tambah Data Baru"><i class="fa fa-plus"></i></a>
                        </div>
                    </div>
                    <h3 class="widget-content-light">
                    <strong>Postingan Lowongan Kerja Anda</strong>
                    </h3>
                </div>
                        ...
                        <ul class="timeline-list">
                            ...
                            <li class="active">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <a href="<?= base_url() ?>panel_career/manaj_loker_hapus/<?php echo encrypt_decrypt('encrypt', $dt1['id']) ?>" class="btn btn-xs btn-danger" onclick="return konfirmHapus()" data-toggle="tooltip" title="Hapus Data"><i class="fa fa-remove"></i></a>
                                    </p>
...
var goEdit = function(el) {
    window.location.assign("<?php echo base_url();?>panel_career/manaj_loker_edit/"+el.id);
}
